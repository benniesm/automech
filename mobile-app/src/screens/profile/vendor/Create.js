...
class CreateVendorProfileContainer extends Component {
  ...
  setVendorLocation = async() => {
    ...
    const modelOne = this.props.state.page.modelOne;

    if (modelOne === 999 || modelOne === null) {
      Alert.alert('Please select car brand');
      return;
    }
          ...
          <View style={Object.assign(
            ...
            <View style={{
              ...
              <Picker
                ...
                <Picker.Item label="SELECT THE SERVICE YOU RENDER" value="" />
                {serviceList}
              </Picker>
            </View>
            <View>
