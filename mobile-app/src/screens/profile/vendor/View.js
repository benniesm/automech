...
class ViewVendorProfileContainer extends Component {
  ...
  render() {
    const profileState = this.props.state.auth.profile;
    const vendorData = profileState.vendor === undefined ? null : profileState.vendor;
            ...
            styles.displayDataIndividual
              ...
              <View style={{ width: '85%' }}>
                <Image
                  ...
                  source={
                    vendorData.image === null || vendorData.image === undefined ?
        ...
        (
          <>
            ...
            <View style={Object.assign({}, styles.window)}>
              {
                profileState === undefined || vendorData === null ?
                  <View>
